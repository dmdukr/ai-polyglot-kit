...
(str(Path(sys.prefix) / 'Lib' / 'site-packages' / 'pymorphy3_dicts_uk'), 'pymorphy3_dicts_uk'),
    ...
    hiddenimports=[
        ...
        'src.context',
        'src.context.db',
        'src.context.keywords',
        'src.context.cooccurrence',
        'src.context.clusters',
        'src.context.threads',
        'src.context.engine',
        'src.context.dictionary',
        'src.context.corrections',
        'src.context.pipeline',
        'src.context.prompt_builder',
        'src.context.script_validator',
        'src.context.maintenance',
        'webview',
        'clr_loader',
        'pythonnet',
        'bottle',
